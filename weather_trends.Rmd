...
(source: https://gml.noaa.gov/grad/solcalc/table.php?lat=35.304442&lon=-120.65925&year=2021)
...
ggplot() +
  ...
  geom_point(data = tmts,
             ...
             color = "black",
              size = 4,
              alpha = 1) +
  scale_fill_distiller(palette = "PuRd", direction = 1, name = "VPD (kPa)") +
  theme_classic() + 
  ...
  annotate("text", label = "Cool Humid\n0.6 kPa",
            x = 26, y = 87, size = 2.6, color = "black") +
  annotate("text", label = "Hot Humid\n1.1 kPa",
            x = 37, y = 90, size = 2.6, color = "black") +
  annotate("text", label = "Cool Dry\n2.5 kPa",
            x = 21, y = 9, size = 2.6, color = "black") +
  annotate("text", label = "Hot Dry\n3.8 kPa",
            x = 38, y = 43, size = 2.6, color = "black") +
  theme(text = element_text(color = "black", 
                            family = "sans", 
                            size = 12),
        axis.text = element_text(color = "black", 
...
ggsave(filename = "exp_vs_weather_fig.pdf",
       plot = tmt_weather_fig_formatted,
