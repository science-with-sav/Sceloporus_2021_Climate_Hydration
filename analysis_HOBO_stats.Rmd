...
tmt_only_means <- format_HOBO_data %>%
  ...
  summarise(temp_mean = mean(temp_C),
            ...
            humidity_mean = mean(relative_humidity),
            humidity_SD = sd(relative_humidity)) %>%
  mutate(#e_s_kPa = 0.611*exp((2500000/461.5)*
          #                        ((1/273)-(1/(temp_mean + 273.15)))),# Riddell
         e_s_kPa = 0.611 * exp((17.502*temp_mean)/(temp_mean + 240.97)), # saturation VP, Campbell & Normal 1998
         # actual vapor pressure
         #e_a_kPa = e_s_kPa * (humidity_mean/100), # Riddell
         #e_a_kPa = ,# Campbell & Normal 1998
         # VPD
         VPD_kPa = e_s_kPa*(1 - (humidity_mean/100))) %>%
  dplyr::select(tmt, VPD_kPa)
tmt_only_means
```
