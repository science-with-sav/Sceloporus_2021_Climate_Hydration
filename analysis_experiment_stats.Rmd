...
use the aictab function in the AICmodavg package to get AIC and ∆AIC values, and
...
I need to double check whether CEWL has a relationship with body temperature at the point of measurement, to make sure I do not need to account for it.
...
ggplot() +
  ...
  annotate(geom = "text", x = 2, y = 14.2, label = "A", 
           size = 3) +
  annotate(geom = "text", x = 2, y = 13.7, label = "9.6", 
           size = 3) +
  annotate(geom = "text", x = 3, y = 14.8, label = "B", 
           size = 3) +
  annotate(geom = "text", x = 3, y = 14.3, label = "10.7", 
           size = 3) +
...
ggplot() +
  ...
  annotate(geom = "text", x = 1, y = 427, label = "A", 
           size = 3) +
  annotate(geom = "text", x = 1, y = 417, label = "362", 
           size = 3) +
  annotate(geom = "text", x = 2, y = 452, label = "A", 
           size = 3) +
  annotate(geom = "text", x = 2, y = 442, label = "354", 
           size = 3) +
  annotate(geom = "text", x = 3, y = 437, label = "A", 
           size = 3) +
  annotate(geom = "text", x = 3, y = 427, label = "349", 
           size = 3) +
  annotate(geom = "text", x = 4, y = 470, label = "A", 
           size = 3) +
  annotate(geom = "text", x = 4, y = 460, label = "350", 
           size = 3) +
