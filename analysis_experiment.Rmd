...
means <- dat %>% # use whole dat because want for both exp and rehyd
  group_by(day_n, tmt) %>%
  summarise(mean_CEWL = mean(CEWL_g_m2h_mean, na.rm = T),
...
CEWL_fig_min
ggsave(filename = "CEWL_fig2.jpeg",
       plot = CEWL_fig_min,
       path = "./results_figures",
       device = "jpeg",
       dpi = 1200,
...
ggsave(filename = "CEWL_fig3.jpeg",
